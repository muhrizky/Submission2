...
import id.ac.undip.ce.student.muhammadrizqi.submission2.event.EventFragment
import id.ac.undip.ce.student.muhammadrizqi.submission2.favorite.FavoriteScheduleFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        else openFragment(EventFragment.newFragment(fixture, leagueId))
